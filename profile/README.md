...
8. Gain some familiarity with a microprocessor and associated electronic components, running Python in hardware.(SF)** 
...
* Weekly Activities
  ...
  * Quizzes or Exams  
  * Team Meetings (V)  
    This will be a time in which students will work as a team over MS Teams on problems - based on group timezone and availability. Attendance reports will be required. 
...
<!--
Piazza
Piazza will be used for online class discussions and course announcements. It also provides students with a platform for getting you help fast and efficiently from classmates, the TAs, and the instructor. Rather than emailing questions to the teaching staff, I encourage you to post your questions on Piazza. If you have trouble with Piazza, you can get help from team@piazza.com. While discussion of ideas and questions are encouraged, code snippets for a homework assignment should not be shared with other students (on Piazza or otherwise). When in doubt, post to instructors and indicate if you are willing for us to answer, including sharing your question and parts of yo ur code with other students. (Posts can be anonymous to other students, but not to instructors.)
-->
